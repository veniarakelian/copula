...
def bayes_kill_max_gumbel(currentModel, newModel, kn, u, v, s, q, Q, zita, chain):
    ...
    if np.any(new):
        ...
        if min_old < min_new:
            ...
            if max_new < max_old and max_new != 0:
                ...
                resultOld = allgumbel(u[current[place - 2] - 1:current[place]], v[current[place - 2] - 1:current[place]])
...
if __name__ == "__main__":
    ...
    result = bayes_kill_max_gumbel(currentModel, newModel, kn, u, v, s, q, Q, zita, chain)
