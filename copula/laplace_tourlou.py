...
def laplace_tourlou(currentModel, u, v, q, numbrk, dist, q, zita, chain):
...
[0.781987318512413]
    ...
    result = laplace_tourlou(currentModel, u, v, q, numbrk, dist, q, zita, chain)
